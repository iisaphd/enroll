Feature: As an admin user I should not have the ability to extend the OE
  of a given Employer with a active enrollment.
  ...
  Scenario: As an HBX Staff with Super Admin subroles I should not be able to extend Open Enrollment for an Employer with a active benefit application
