...
RSpec.describe "views/benefit_sponsors/profiles/employers/employer_profiles/_show_profile", :type => :view, dbclean: :after_each do
  ...
  let(:census_employee1) { FactoryBot.create(:benefit_sponsors_census_employee, employer_profile: employer_profile) }
  let(:census_employee2) { FactoryBot.create(:benefit_sponsors_census_employee, employer_profile: employer_profile) }
  let(:census_employee3) { FactoryBot.create(:benefit_sponsors_census_employee, employer_profile: employer_profile) }
