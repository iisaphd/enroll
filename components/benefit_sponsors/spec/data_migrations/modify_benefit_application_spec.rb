  ...
  describe "modifying benefit application", dbclean: :after_each do
    ...
    context "cancel benefit application", dbclean: :after_each do
      ...
      let!(:draft_benefit_application) do
        application = FactoryBot.create(:benefit_sponsors_benefit_application, :with_benefit_sponsor_catalog, benefit_sponsorship: benefit_sponsorship, aasm_state: :imported, effective_period: past_effective_period)
        application.benefit_sponsor_catalog.save!
        application.save
        application
      end
      ...
      let!(:import_draft_benefit_application) {
        application = FactoryBot.create(:benefit_sponsors_benefit_application, :with_benefit_sponsor_catalog, benefit_sponsorship: benefit_sponsorship, aasm_state: :imported, effective_period: range_effective_period)
        application.benefit_sponsor_catalog.save!
        application.save
        application
      }
    ...
    context "Should force publish the benefit application", dbclean: :after_each do
      let(:effective_date) { start_on }
      let!(:ben_package) { benefit_package }
