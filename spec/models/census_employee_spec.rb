...
RSpec.describe CensusEmployee, type: :model, dbclean: :after_each do
  ...
  context '.create_benefit_group_assignment' do
    ...
    context 'when benefit groups are switched' do
      # let!(:blue_collar_benefit_group_assignment) {FactoryBot.create(:benefit_sponsors_benefit_group_assignment, benefit_group: blue_collar_benefit_group, census_employee: census_employee, start_on: blue_collar_benefit_group.start_on, end_on: blue_collar_benefit_group.end_on)}
      ...
      it 'should create benefit_group_assignment' do
        ...
        expect(census_employee.active_benefit_group_assignment).not_to eq white_collar_benefit_group_assignment
      end
  ...
  context "when active employeees opt to waive" do
    ...
    let(:census_employee) do
      build :benefit_sponsors_census_employee,
                       employer_profile: employer_profile,
                       benefit_sponsorship: organization.active_benefit_sponsorship,
