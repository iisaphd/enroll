...
describe MakeBenefitGroupAssignmentActive, dbclean: :after_each do
  ...
  describe 'creates an inactive benefit group assignment' do
    ...
    let!(:benefit_group_assignment)  { create(:benefit_group_assignment, census_employee: census_employee, benefit_package: benefit_package, start_on: benefit_package.start_on, end_on: benefit_package.end_on) }
