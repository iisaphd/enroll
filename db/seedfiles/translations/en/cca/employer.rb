...
EMPLOYER_TRANSLATIONS = {
  ...
  :'en.employers.plan_years.benefits_title_with_draft_py' => "Set up your benefits",
  ...
  :'en.employers.plan_years.fte_text' => "Full Time Employees must be greater than 0",
  :'en.employers.plan_years.fte_label' => "Full Time Employees*",
  :'en.employers.plan_years.pte_label' => "Part Time Employees",
  :'en.employers.plan_years.msp_label' => "Employees on Medicare",
  ...
  :'en.employers.plan_years.benefit_package.estimated_premiums_contribution_details1' => "The Employer Reference Plan Contribution reflects the estimated monthly employer share of the premium for each employee based on the selected reference plan. The employer share of the premium will stay the same no matter which plan employees choose.",
  ...
  :'en.employers.plan_years.estimated_monthly_cost_title' => "Employer Estimated Monthly Cost",
  :'en.employers.plan_years.estimated_monthly_cost_description' => "Estimated monthly cost for employees listed as 'enroll' in the employer census",
