...
How to find the SEVIS ID: On the DS-2019, the number is on the top right hand side of the page in the box above the barcode.",
  ...
  :'en.waiver_effective_from' => "Waiver Effective From",
  ...
  :'en.confirm_your_waiver_selection' => "Confirm Your Waiver Selection",
  ...
  :'en.insured.plan_shoppings.waiver_receipt.waiver_receipt_header_html' => "<h3>Waiver confirmation</h3>",
  :'en.insured.plan_shoppings.waiver_receipt.health_waiver_receipt_html' => "<p>You have successfully waived %{coverage_kind} coverage at %{updated_at}. </p><p>Waiver Reason : %{waiver_reason}. </p>",
  :'en.insured.plan_shoppings.waiver_receipt.dental_waiver_receipt_html' => "<p>You have successfully waived %{coverage_kind} coverage at %{updated_at}. </p><p>Please print this page for your records. </p>",
  :'en.print' => "Print",
  :'en.insured.plan_shoppings.show.title' => "Enroll in a plan",
  :'en.insured.plan_shoppings.show.health_title' => "Enroll in a Health Plan",
  :'en.insured.plan_shoppings.show.dental_title' => "Enroll in a Dental Plan",
  ...
  :'en.insured.plan_shoppings.thankyou.confirm_your_waiver_selection.content' => "Please review your current waiver selection. If you want to change your plan, select 'Previous' to go back. If you’ve decided on waiving and are ready to complete your Waiver, select 'Confirm'.",
  ...
  :'en.enrollment_submitted_text_4' => "enrollment",
  :'en.enrollment_submitted_text_5' => "have been submitted as of",
  :'en.enrollment_submitted_text_6' => "has been submitted as of",
