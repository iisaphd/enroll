module Employers::EmployerHelper
  ...
  def get_benefit_packages_for_census_employee
    initial_benefit_packages = @benefit_sponsorship.current_benefit_application.benefit_packages if !@benefit_sponsorship.current_benefit_application&.terminated?
